...
``PDA.ext.tasks`` -- asyncio.Task helpers
====================================================
...
The goal of this PDA.py extension is to abstract all these worries away from you.

Recipes
---------

A simple background task in a :class:`~PDA.ext.commands.Cog`:

.. code-block:: python3

    from PDA.ext import tasks, commands
...
.. attributetable:: PDA.ext.tasks.Loop

.. autoclass:: PDA.ext.tasks.Loop()
    :members:
...
.. autofunction:: PDA.ext.tasks.loop
